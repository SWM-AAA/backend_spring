...
public class StompRabbitController {
    ...
    public void enter(ChatMessageRequest chat, @DestinationVariable String chatRoomId){
    ...
    public void send(ChatMessageRequest chat, @DestinationVariable String chatRoomId){
    ...
    public void receive(ChatMessageRequest chat){
